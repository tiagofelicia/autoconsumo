...
datas_futuras <- seq(from = max(dados_combinados_qh$Data) + 1, to = as.Date("2025-12-31"), by = "day")
...
tryCatch({
  ...
  writeData(wb, sheet = "Constantes", x = format(ultima_data_omie, "%m/%d/%Y"), startCol = 2, startRow = 42, colNames = FALSE)
  writeData(wb, sheet = "Constantes", x = format(data_relatorio_omip, "%m/%d/%Y"), startCol = 2, startRow = 43, colNames = FALSE)
